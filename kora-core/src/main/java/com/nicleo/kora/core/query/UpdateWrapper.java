...
public final class UpdateWrapper {
    ...
    public <T> UpdateWrapper setNull(Column<T, ?> column) {
        return set(column, Expressions.literal(null));
    }

    public <T> UpdateWrapper setNull(boolean include, Column<T, ?> column) {
        return set(include, column, Expressions.literal(null));
    }
    ...
    public UpdateWrapper where(Condition... conditions) {
