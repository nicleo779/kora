...
public final class SqlExecutionContext {
    ...
    public static SqlExecutionContext select(SqlSession sqlSession, Class<?> resultType) {
        return new SqlExecutionContext(sqlSession, null, null, null, SqlCommandType.SELECT, resultType, true);
    }

    public static SqlExecutionContext update(SqlSession sqlSession) {
        return new SqlExecutionContext(sqlSession, null, null, null, SqlCommandType.UPDATE, null, true);
    }

    public SqlExecutionContext withSqlSession(SqlSession sqlSession) {
        return new SqlExecutionContext(sqlSession, mapperClassName, mapperMethodName, statementId, commandType, resultType, interceptorEnabled);
    }

    public SqlExecutionContext withoutInterceptors() {
        return new SqlExecutionContext(sqlSession, mapperClassName, mapperMethodName, statementId, commandType, resultType, false);
    }
