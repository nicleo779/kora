...
public final class StandardOffsetFetchDialect extends AbstractSqlDialect {
    private StandardOffsetFetchDialect(String id, DbType dbType, String quote) {
        super(
                id,
                dbType,
                "[".equals(quote) ? new StandardIdentifierPolicy("[", "]") : new StandardIdentifierPolicy(quote),
    ...
    public static StandardOffsetFetchDialect oracle() {
        return new StandardOffsetFetchDialect("oracle", DbType.ORACLE, "\"");
    }

    public static StandardOffsetFetchDialect sqlServer() {
        return new StandardOffsetFetchDialect("sqlserver", DbType.SQLSERVER, "[");
    }
}
