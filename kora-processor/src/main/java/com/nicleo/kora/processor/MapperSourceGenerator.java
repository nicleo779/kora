...
final class MapperSourceGenerator {
    ...
    String buildMapperSource(String packageName,
        ...
        String mapperEntityTypeLiteral = context.mapperEntityTypeLiteral(mapperType);
        TypeElement mapperEntityType = context.mapperEntityType(mapperType);
        String packageBlock = packageName.isEmpty() ? "" : "package %s;%n%n".formatted(packageName);
    ...
    interface Context {
        ...
        String mapperEntityTypeLiteral(TypeElement mapperType);

        TypeElement mapperEntityType(TypeElement mapperType);
